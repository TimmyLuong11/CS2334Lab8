/**
 * Enum to represent the game pieces available in a board game. 
 * Each game piece has a color and a shape (represented by a GamePieceAppearance object) 
 * and move priority (the piece with the lowest priority value gets to move first, turns are taken in priority value order (increasing)). 
...
public enum GamePiece
{
	...
	/**
	 * Game Piece apperance and priority
	 * 
	 * @param apperance
	 * @param priority
	 */
	 ...
	 * (4) The priority value of the piece 
	 */
	@Override
